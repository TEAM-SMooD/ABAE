...
parser.add_argument("--domain", dest="domain", type=str, metavar='<str>', default='restaurant', help="domain of the corpus restaurant")
...
cluster_map = {0: '기타', 1: '룸', 2: '룸', 3: '룸',
            4: '목적', 5: '위치', 6:'가성비', 7: '서비스', 8: '위치', 
            9: '서비스',10:'룸',11:'룸',12:'룸',13:'룸'}
